...
int main(int argc, char **argv) {
    ...
    N3_Non_Gray_M2_3D_RT_Cheby :: Problem_Type = NON_GRAY;
    ...
    strcat(path_N3_ijk_out, "/M2_Model/Non_Gray_M2_Model/Coefficients_Fit_N3_ijk_Non_Gray_BE.dat");
                                
    out_N3_ijk.open(path_N3_ijk_out);    
    if (!out_N3_ijk) {
        cout << "Coefficients_Fit_N3_ijk_Non_Gray_BE.dat output file could not be accessed" << endl;
    }
    
    N_pts_Mobius_Scale = 100;
    N_Points_E = 4;
    N_Points_f = 3;
    N_Points_Phi = 8;
    N_Points_Theta = 4; 
...
//     N3_M2_3D_RT_Unif_HL.OpenInputFile("Non_Gray_M2_Model/Uniform_N3_Non_Gray_M2_3D_HL");
//     N3_M2_3D_RT_Unif_HL.ReadInputData();
//     N3_M2_3D_RT_Unif_HL.CloseInputFile();
//     N3_M2_3D_RT_Unif_HL.SetupInterpolant_Values_HL_LL();
//     N3_M2_3D_RT_Unif_HL.Write_Data_Matlab(HYPERBOLIC_LIMIT);
...
//     N3_M2_3D_RT_Unif_LL.OpenInputFile("Non_Gray_M2_Model/Uniform_N3_Non_Gray_M2_3D_LL");
//     N3_M2_3D_RT_Unif_LL.ReadInputData();
//     N3_M2_3D_RT_Unif_LL.CloseInputFile();
//     N3_M2_3D_RT_Unif_LL.SetupInterpolant_Values_HL_LL();
    // N3_M2_3D_RT_Unif_LL.Write_Data_Matlab(LOGARITHMIC_LIMIT);
    ...
    N3_M2_3D_RT_Unif.num_proc_E = N_Points_E;
    N3_M2_3D_RT_Unif.num_proc_f = 1; //N_Points_f;
    N3_M2_3D_RT_Unif.num_proc_Phi = N_Points_Theta;
    N3_M2_3D_RT_Unif.num_proc_Theta = N_Points_Theta;
    N3_M2_3D_RT_Unif.num_proc_Triangle_gam1_gam2 = 5;
    ...
    N3_M2_3D_RT_Unif.OpenInputFile("Non_Gray_M2_Model/Uniform_N3_Non_Gray_M2_3D_BE");
    ...
    N_Coeffs_f = 3;
    Order_SH = 4;
    N_Coeffs_Phi = 8; //20; // 2*(Order_SH + 1);
    N_Coeffs_Theta = 4; //10; //(Order_SH + 1);
    N_Coeffs_gam1 = 4;
    ...
    N3_M2_3D_RT_Cheby.num_proc_E = N_Coeffs_E;
    N3_M2_3D_RT_Cheby.num_proc_f = 1; //N_Coeffs_f;
    N3_M2_3D_RT_Cheby.num_proc_Phi = N_Coeffs_Theta;
    N3_M2_3D_RT_Cheby.num_proc_Theta = N_Coeffs_Theta;
    N3_M2_3D_RT_Cheby.num_proc_Triangle_gam1_gam2 = 5; //10;
    
    N3_M2_3D_RT_Cheby.Polynomial_Interpolation_Non_Gray_M2_N3_ijk(N3_M2_3D_RT_Unif, out_N3_ijk);
